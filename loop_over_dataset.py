...
show_only_frames = [50, 51] #  [0, 200] # [0, 1] # [50, 150] # [50, 51] # [0, 1] #[0, 200] #[0, 1] # [50, 51] #[0, 1] # show only frames in interval for debugging
...
# print ()
# print ('------------------------------------------------------------')
# print (f"results_fullpath {results_fullpath}") # results_fullpath C:\Users\seneca_wolf\Desktop\sdcend_udacity_2021\nd013-c2-fusion-starter-main\results
# print ('------------------------------------------------------------')
# print () 
#input ('enter to CONTINUEEEEE!!!!!') 
...
exec_detection = ['bev_from_pcl', 'detect_objects'] # [] # ['bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] # ['bev_from_pcl', 'detect_objects']  # ['bev_from_pcl'] # []  
exec_tracking = [] # options are 'perform_tracking'
exec_visualization = ['show_objects_in_bev_labels_in_camera'] # ['show_pcl'] # ['show_range_image'] # ['show_detection_performance'] # ['show_objects_in_bev_labels_in_camera'] # [] # ['show_pcl'] # ['show_range_image']
...
# exec_list: ['bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance', 
# 'show_detection_performance', 'pcl_from_rangeimage']
    ...
    try:
        ...
        if (configs_det.use_labels_as_objects==True):
            ...
            if 'detect_objects' in exec_list:
                ...
                # input ('congratulations on your detections Sherlock!!!')
            else:
