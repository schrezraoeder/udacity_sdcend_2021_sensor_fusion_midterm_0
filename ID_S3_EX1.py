...
# this file is for interactively running ID_S3_EX1 for checking purposes without manually
# resetting all the configurations at the beginning to check for ID_S3_EX1 

# basically the code in here is copied from `loop_over_dataset` with the settings set as to run ID_S3_EX1 
...
exec_visualization = ['show_detection_performance'] # ['show_objects_in_bev_labels_in_camera'] # ['show_detection_performance'] # ['show_pcl'] # ['show_range_image'] # [] # ['show_pcl'] # options are 'show_range_image', 'show_bev', 'show_pcl', 'show_labels_in_image', 'show_objects_and_labels_in_bev', 'show_objects_in_bev_labels_in_camera', 'show_tracks', 'show_detection_performance', 'make_tracking_movie'
